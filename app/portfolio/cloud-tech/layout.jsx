...
import Firebase from '@/app/icons/tools/Firebase'
...
export default function Layout({children}) {
    ...
    return (
        <div className='flex flex-col items-center justify-start w-full h-full'>
            <AppBar title={'Cloud Technologies'} />
            <div className='flex items-center w-full justify-center h-full overflow-hidden'>
                ...
                <ToolsBar>
                    ...
                    <div className='flex flex-col w-full h-full p-3 gap-1'>
                        <ToolsNavButton text={"Firebase"} link={"/portfolio/design/figma"} icon={<Firebase forButton={true}/>} />
                    </div>
                </ToolsBar>
            </div>
        </div>
